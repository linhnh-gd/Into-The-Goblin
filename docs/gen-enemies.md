...
| Ogre Hầm | en_heavy_ogreham | heavy | D3 | 320 | 26 | 1.4 | 0.85 | 6.0 | 20 | Gần như không đẩy được. Đập đất gây AoE 2.5m, telegraph 0.6s | Kite bằng Bước Lùi, bắn yếu điểm ở bụng (x2.0) |
| Goblin Khiên | en_special_khien | special | D3 | 90 | 10 | 1.6 | 0.55 | 3.0 | 7 | Khiên chắn chính diện: damage tầm xa x0.3, kbResist 0.55 (sau lưng chỉ 0.05). Vung khiên mỗi 4s, hở 0.8s | Búa (bỏ qua khiên), chém nặng, axit, hoặc đánh khi nó vung khiên |
...
| Goblin Đào Hầm | en_special_daoham | special | D4 | 45 | 14 | 2.4 | 0.20 | 2.4 | 8 | Trồi lên từ sàn PHÍA SAU người chơi sau 2.5s, có tiếng đất nứt báo trước 0.8s | Bước Lùi rồi quay chém — dạy người chơi rằng phía sau cũng tồn tại |
