...
> Sinh ra bởi `build_pages.ps1` từ `data/upgrades.json`. **KHÔNG sửa tay** — sửa data rồi build lại.
...
| Tên | ID | Hiệu ứng | Giá phải trả | Nguồn |
|---|---|---|---|---|
...
| Bóng Đồng Minh | rl_bongdongminh | Một bóng đen bắn theo 30% damage của bạn, không bị đánh | — | boss4 |
| Tim Sắt | rl_timsat | Sống sót một lần với 1 HP (1 lần/run), 2s bất tử | — | boss5 |
| Đèn Không Tắt | rl_dendaubat | Sương Đen không bao giờ kích hoạt | Vàng -20% | cuakhoa |
| Lưỡi Liềm Gió | rl_luoiliemgio | Slide dọc lên (Xốc Tới) cũng gây damage cận chiến toàn tuyến đi qua | — | boss6 |
| Lõi Mỏ | rl_loimo | Vũ khí deeptech tính Depth như Depth +2; Lộc tối đa 20 -> 28 | — | boss7 |
